...
public class ExtEWMA {
     ...
     */
    public static ExtEWMA oneMinuteEWMA() {
        return new ExtEWMA(M1_ALPHA, INTERVAL, TimeUnit.SECONDS);
    }
     ...
     */
    public static ExtEWMA fiveMinuteEWMA() {
        return new ExtEWMA(M5_ALPHA, INTERVAL, TimeUnit.SECONDS);
    }
     ...
     */
    public static ExtEWMA fifteenMinuteEWMA() {
        return new ExtEWMA(M15_ALPHA, INTERVAL, TimeUnit.SECONDS);
    }
     ...
     */
    public ExtEWMA(double alpha, long interval, TimeUnit intervalUnit) {
