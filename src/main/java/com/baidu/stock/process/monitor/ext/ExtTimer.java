 ...
 *
 */
public class ExtTimer implements Metered, Sampling {
    /**
     * A timing context.
     *
     * @see Timer#time()
    ...
    public static class Context implements Closeable {
        private final ExtTimer timer;
        private final Clock clock;
        private final long startTime;

        private Context(ExtTimer timer, Clock clock) {
            this.timer = timer;
            this.clock = clock;
    ...
    private final ExtHistogram histogram;
    private final Clock clock;
     ...
     */
    public ExtTimer(Reservoir reservoir) {
     ...
     */
    public ExtTimer(Reservoir reservoir, Clock clock) {
        this.meter = new Meter(clock);
        this.clock = clock;
        this.histogram = new ExtHistogram(reservoir);
    }
